...
public class HexLeftNeighborhood implements Neighborhood{
    ...
    public int[][] getNeighbors(Grain grain) {
        ...
        newNeighbors[1][0] = originalNeighbors[2][0];
        newNeighbors[1][1] = originalNeighbors[2][1];
        newNeighbors[2][0] = originalNeighbors[3][0];
        newNeighbors[2][1] = originalNeighbors[3][1];
        ...
        newNeighbors[5][0] = originalNeighbors[7][0];
        newNeighbors[5][1] = originalNeighbors[7][1];
